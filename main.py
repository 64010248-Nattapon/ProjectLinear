...
# encoder.set_message(input("enter meessage :"))
...
print("Message in integer format: ","[66, 79, 82, 65, 69]")
# print("Encoded message in integer format: ","[82, 75, 53, 62, 83, 4, 42, 25]")
print("Encoded message: "+"[82, 75, 53, 62, 83, 4, 42, 25]")
print("decoded message: "+str(inp))